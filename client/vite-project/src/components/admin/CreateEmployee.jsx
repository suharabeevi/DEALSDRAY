  ...
  return (
    ...
    <form className="bg-white p-10 rounded-lg shadow-lg ">
        ...
        <div className="relative mb-4 flex items-center">
            <label htmlFor="name" className="block text-gray-700 w-24">Name</label>
            <input
                type="text"
                name="name"
                id="name"
        ...
        <div className="relative mb-4 flex items-center">
            <label htmlFor="email" className="block text-gray-700 w-24">Email</label>
            <input
                type="email"
                name="email"
                id="email"
        ...
        <div className="relative mb-4 flex items-center">
            <label htmlFor="phone" className="block text-gray-700 w-24">Phone</label>
            <input
                type="tel"
                name="phone"
                id="phone"
        ...
        <div className="relative mb-4 flex items-center">
            <label htmlFor="gender" className="block text-gray-700 w-24">Designation</label>
            <select
                name="designation"
                id="designation"
                className="flex-1 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
